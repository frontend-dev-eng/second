...
import {DuroltLogoIcon, RADIO_CHECKED_ICON, RADIO_UNCHECKED_ICON} from '../assets/constants/Icons';
...
const LockerSizePage = () => {
    ...
    useEffect(() => {
        console.log(`price is enable:`,isPricingEnabled)
        if (isPricingEnabled) {
                    ...
                    {availableLockerSizes.map((item, index) => (
                        <div className='locker-size accordion' key={index}>
                            <button className='accordion-header' onClick={() => lockerSizeClickHandler(item)}>
                                ...
                                <p className='units-available'>{item.available_doors_count} {available}</p>
                                {isPricingEnabled && (
                            ...
                            {/* <div className="locker-footer">
                                <p className="locker-footer-label">No. of Lockers</p>
                                <div className="locker-stepper">
                            ...
                            {isPricingEnabled && showBookingSlots && selectedSizeId === item.id && (
                                ...
                                <div className='table-header-row'>
                                    ...
                                    <p className='price-heading'>Price ({item?.currency})</p>
                                </div>
                                {item?.bookingSlots.map((bookingSlot, index) => (
                                    <div
                                    key={index}
