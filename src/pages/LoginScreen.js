                ...
                <Box className='main'>
                    <Box className="logo_style">
                        ...
                        <Box className="formView">
                            ...
                            {/* <Box className= { customer ==="HiveBoard" ? "input-tab-bar-container": "input-tab-durolt-container"} ></Box> */}
                            <Tabs className='tab-bar' classes={{indicator : 'indicator-style'}}value={tabValue} onChange={handleChange} aria-label="basic tabs example">
                             ...
                             {/* 
                             {isEmailOtpEnabled && (<Tab className="tab-bar-label" 
                               label={ customer ==="Durolt"? "Email": t('emailAddressLabel')}/>)}
                               */}  
                            </Tabs>
                            </Box>
                            ...
                            <Box className="login-button">
                                <ButtonComponent handleClick={validation} title={isLoading ? <CircularProgress size={24} /> :
                                 t("loginBtnText")} disabled={customer === "Durolt" && disabled} />
                            </Box>
                            </>}
