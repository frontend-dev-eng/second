...
const PersonalLockerPage = ({ history }) => {
    ...
    const requestToAssign = async () => {
        try {
            ...
            if (accessToken && domain) {
                try {
                    const response = "" //await requestToAssignment('personal', releaseMsg, domain, accessToken);
            ...
            console.log('RequestToAssignment Error', e);
        }
    };
            ...
            <Box className='main-container'>
                <Box className='main'>
                    <Box className='container'>
                        <Typography className="title" color="textPrimary">{t('requestPersonalLocker')}</Typography>
                        <CustomTextInput
...
export default PersonalLockerPage;